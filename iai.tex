...
%			Fax: (888) 555--1212}
	...
	\section{Related Work}
		...
		the MDP, which is something that does not naturally fit our scenario of providing hints (actions) in
		different states (problems) since the core element of our problem is the uncertainty in the action rewards
		and the emphasis on the uncertainty in state changes is not very useful here.
	...
	programming skills. We will try to fit our modeling to this scenario and it can be seen that no semantic
	dependency is formed between the two and other problems can be mapped to this model conveniently by
	only defining the required model specific parameters and metrics.
	...
	\begin{enumerate}
		...
		which can define a unit of work for an already expert member of the team. 
	\end{enumerate}


	\section{Implementation}
	
	Talk about the implementation scope
	
	\section{Evaluation}
	% no \IEEEPARstart
	
	Talk about how you want to test.
